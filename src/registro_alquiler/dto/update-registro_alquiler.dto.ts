...
import { CreateRegistroAlquilerDto } from './create-registro_alquiler.dto';

export class UpdateRegistroAlquilerDto extends PartialType(CreateRegistroAlquilerDto) {
